<!-- Second Tab content -->
<div id="klick_404_tab_second">
	<h1><img src="<?php echo KLICK_404_PLUGIN_URL . '/images/klick-on-it.png'; ?>"> <?php _e('Our new and upcoming plugins', 'klick-404'); ?></h1>
	<br>
	<ul class="klick-404-plugin-list">
		<?php 
		...
		foreach ($logo_links as $key => $value) { ?>
			<li>
				<img src="<?php echo KLICK_404_PLUGIN_URL . '/images/our-more-plugins/' . $value['link_logo'] . '.svg';?>">
				<h4><a href="http://klick-on-it.com/wordpress-plugins/<?php echo $value['link_name']; ?>"><?php _e('Visit here', 'klick-404'); ?></a></h4>
			</li>	
		<?php } ?>
	</ul>
</div>
