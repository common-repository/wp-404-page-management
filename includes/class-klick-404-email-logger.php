...
if (class_exists('Klick_404_EMAIL_Logger')) return;

/**
 * Class Klick_404_EMAIL_Logger
 */
class Klick_404_EMAIL_Logger extends Klick_404_Abstract_Logger {
	...
	/**
	 * Klick_404_EMAIL_Logger constructor
	 */
	...
	public function get_description() {
		return __('Log events into Url address', 'klick-404');
	}
